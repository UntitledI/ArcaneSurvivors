...
public class IKDrivingSystemEditor : Editor
{
	...
	public void showFreeMoveHandle (Transform currentTransform, string handleName, float handleRadius)
	{
		...
		var fmh_1037_78_638146060113090709 = Quaternion.identity; newFreeHandlePosition = Handles.FreeMoveHandle (currentFreeHandlePosition, handleRadius, snapValue, Handles.CircleHandleCap);
