...
public class IKWeaponSystemEditor : Editor
{
	...
	public void showFreeMoveHandle (Transform currentTransform, string handleName, float handleRadius)
	{
		...
		var fmh_606_78_638146060114476220 = Quaternion.identity; newFreeHandlePosition = Handles.FreeMoveHandle (currentFreeHandlePosition, handleRadius, snapValue, Handles.CircleHandleCap);
